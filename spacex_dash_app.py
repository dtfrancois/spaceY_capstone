...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(values, values = values.values, 
        names=values.index,
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        title='Corelation between payload success for all sites')
        return fig
    else:
        filtered_df = filtered_df[filtered_df["Launch Site"] == entered_site]
        fig = px.scatter(filtered_df, x="Payload Mass (kg)", y="class",
        color="Booster Version Category",
        title='Corelation between payload success for site ' + entered_site)
        return fig
